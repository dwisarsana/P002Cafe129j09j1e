        ...
        slivers: [
          ...
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              background: Stack(
                ...
                children: [
                  Image.asset(
                    "assets/images/banner_home_hero.jpeg",
                    fit: BoxFit.cover,
          ...
          SliverToBoxAdapter(
            child: FutureBuilder<List<KitchenModel>>(
              future: context.read<StorageService>().loadKitchens(),
              builder: (context, snapshot) {
                final kitchens = snapshot.data ?? [];
                if (kitchens.isEmpty) return const SizedBox();
                ...
                return SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    padding: const EdgeInsets.symmetric(horizontal: 24),
                    physics: const BouncingScrollPhysics(),
                    itemCount: kitchens.length > 5 ? 5 : kitchens.length,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "The most loved styles by the community",
                    style: Theme.of(
                      context,
          ...
          SliverPadding(
            ...
            sliver: SliverGrid(
              ...
              delegate: SliverChildBuilderDelegate(
                ...
                childCount: MockData.styles.length > 4
                    ? 4
                    : MockData.styles.length,
              ),
            ),
          ),
      ...
      child: Container(
        ...
        child: ClipRRect(
          ...
          child: Stack(
            fit: StackFit.expand,
            children: [
              imageBuilder(kitchen.resultImagePath),
              Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    begin: Alignment.topCenter,
              ...
              Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "${kitchen.timestamp.day}/${kitchen.timestamp.month}",
                      style: TextStyle(
