...
class _SceneDetectionScreenState extends State<SceneDetectionScreen>
  ...
  final List<Map<String, dynamic>> _analysisSteps = [
    ...
    {'label': 'Analyzing cabinetry...', 'icon': Icons.kitchen_rounded},
    {'label': 'Measuring light conditions...', 'icon': Icons.wb_sunny_rounded},
    {'label': 'Identifying appliances...', 'icon': Icons.soup_kitchen_rounded},
    {'label': 'Mapping layout...', 'icon': Icons.grid_view_rounded},
  ];
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: [
                          Colors.transparent,
                          AppTheme.burntOrange.withValues(alpha: 0.8),
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: AppTheme.burntOrange.withValues(alpha: 0.5),
                          blurRadius: 20,
                          spreadRadius: 5,
                        ),
                      ],
                    ...
                    children: [
                      if (!_scanComplete)
                        ...
                        const Icon(Icons.check_circle_rounded,
                            color: AppTheme.burntOrange, size: 22),
                          ...
                          AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              color: isDone
                                  ...
                                  : isCurrent
                                      ? AppTheme.butterYellow.withValues(alpha: 0.2)
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color:
                              _scanComplete ? AppTheme.burntOrange : Colors.red,
                          boxShadow: [
                            BoxShadow(
                              color: (_scanComplete
                                      ? AppTheme.burntOrange
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: AppTheme.burntOrange.withValues(alpha: 0.6),
          width: 1,
        ),
        boxShadow: [
          BoxShadow(
      ...
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(icon, size: 12, color: AppTheme.burntOrange),
