...
class _UploadScreenState extends State<UploadScreen>
  ...
  final List<Map<String, dynamic>> _tips = [
    ...
    },
    {
      ...
      'desc': 'Clear photos produce more detailed kitchen designs',
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: Container(
            ...
            decoration: BoxDecoration(
              color: AppTheme.flourWhite.withValues(alpha: 0.9),
          ...
          children: [
            Container(
              ...
              child: const Icon(Icons.eco_rounded,
                  color: AppTheme.burntOrange, size: 18),
            ),
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: AppTheme.burntOrange.withValues(alpha: 0.04),
              ),
            ),
          ),
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                color: AppTheme.butterYellow.withValues(alpha: 0.04),
              ),
            ),
          ),
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      "AI-powered kitchen design in seconds",
                      style:
                      ...
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          color: _selectedImage != null
                              ? Colors.black
                              : AppTheme.flourWhite.withValues(alpha: 0.7),
                    ...
                    child: PageView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            color: AppTheme.flourWhite.withValues(alpha: 0.8),
                            borderRadius: BorderRadius.circular(20),
                            border: Border.all(
