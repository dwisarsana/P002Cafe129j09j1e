...
class _StyleLibraryScreenState extends State<StyleLibraryScreen>
  ...
  List<KitchenStyle> get _filteredStyles {
  ...
  void _showStyleDetail(KitchenStyle style) {
          ...
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              background: Stack(
                ...
                children: [
                  Image.asset(
                    "assets/images/banner_style_library.jpeg",
                    fit: BoxFit.cover,
                  ),
                  Container(
                    decoration: BoxDecoration(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: isSelected
                            ? [
                                BoxShadow(
                                  color:
                                      AppTheme.burntOrange.withValues(alpha: 0.25),
                                  blurRadius: 12,
...
class _StyleGridCard extends StatelessWidget {
                        ...
                        Row(
                          children: [
                            const Icon(Icons.star_rounded,
                                color: AppTheme.butterYellow, size: 14),
  ...
  Color _getDifficultyColor(String difficulty) {
    switch (difficulty) {
      case 'Easy':
        return AppTheme.burntOrange;
      case 'Medium':
        return AppTheme.butterYellow;
      case 'Hard':
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              const Icon(Icons.star_rounded,
                                  color: AppTheme.butterYellow, size: 20),
                      ...
                      if (style.moodDescription.isNotEmpty) ...[
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            fontSize: 15,
                            color: AppTheme.burntOrange.withValues(alpha: 0.8),
                          ...
                          child: Row(
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: AppTheme.goldenYellow.withValues(alpha: 0.15),
                                  borderRadius: BorderRadius.circular(8),
                                ),
                                child: const Icon(
                                  Icons.check_rounded,
                              ...
                              Text(
                                ...
                                style: TextStyle(
                                  fontSize: 14,
                                  color: AppTheme.darkOven.withValues(alpha: 0.8),
                                ),
                              ),
                            ],
                          ),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            ...
                            elevation: 4,
                            shadowColor:
                                AppTheme.burntOrange.withValues(alpha: 0.3),
                          ),
                          child: Row(
