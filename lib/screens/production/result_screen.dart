...
class _ResultScreenState extends State<ResultScreen> {
            ...
            child: Center(
              child: CircularProgressIndicator(
                value: progress.expectedTotalBytes != null
                    ...
                    : null,
                valueColor:
                    const AlwaysStoppedAnimation<Color>(AppTheme.goldenYellow),
              ),
            ),
          );
        },
  ...
  void _saveKitchen() async {
    HapticFeedback.mediumImpact();
    final storage = context.read<StorageService>();
    final current = await storage.loadKitchens();
    ...
    if (!alreadySaved) {
      await storage.saveKitchens(current); // already saved by generating screen
    }
        ...
        SnackBar(
          ...
          content: const Row(
            children: [
              ...
              SizedBox(width: 10),
              Text('Saved to your kitchen collection!',
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () async {
                    ...
                    final storage = context.read<StorageService>();
                    final kitchens = await storage.loadKitchens();
                    final index = kitchens.indexWhere((g) => g.resultImagePath == widget.resultPath);
                    if (index != -1) {
                      await storage.toggleFavorite(kitchens[index].id);
                    }
                  },
                  child: Container(
                    padding: const EdgeInsets.all(10),
                    ...
                    child: const Row(
                      ...
                      children: [
                        Icon(Icons.auto_awesome_rounded,
                            color: AppTheme.goldenYellow, size: 16),
                        SizedBox(width: 8),
                        Text(
                      ...
                      Expanded(
                        child: SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: _isSaved ? null : _saveKitchen,
