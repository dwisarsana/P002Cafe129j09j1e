...
import '../../services/kitchen_generation_service.dart';
...
class _GeneratingScreenState extends State<GeneratingScreen>
  ...
  final _service = KitchenGenerationService();

  String _statusMessage = 'Analyzing your kitchen...';
  ...
  Future<void> _generate() async {
    final messages = [
      (0.1, 'Analyzing kitchen space...'),
      (0.25, 'Building style prompt...'),
      (0.45, 'Connecting to AI service...'),
      (0.65, 'Generating your kitchen design...'),
    ...
    try {
      ...
      setState(() {
        _progress = 1.0;
        _statusMessage = 'Your kitchen is ready!';
      });
  ...
  Future<void> _saveToHistory(String resultUrl) async {
    try {
      ...
      await storage.saveKitchens([kitchen, ...current]);
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: SweepGradient(
                      colors: [
                        AppTheme.burntOrange.withValues(alpha: 0.0),
                        AppTheme.burntOrange.withValues(alpha: 0.6),
                      ],
                    ),
                  ),
                ),
            ...
            ClipRRect(
              ...
              child: TweenAnimationBuilder<double>(
                ...
                builder: (_, val, __) => LinearProgressIndicator(
                  ...
                  valueColor:
                      const AlwaysStoppedAnimation<Color>(AppTheme.burntOrange),
                ),
              ),
            ),
          ],
    ...
    return Column(
      ...
      children: [
        Container(
          ...
          child: Image.asset(
            'assets/images/state_error_connection.jpeg',
            width: 140,
            height: 140,
            fit: BoxFit.contain,
          ),
