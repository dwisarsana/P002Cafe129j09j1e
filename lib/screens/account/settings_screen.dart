            ...
            children: [
                      ...
                      children: [
                        ListTile(
                          leading: Icon(
                            ...
                            color: isPro ? Colors.amber : AppTheme.burntOrange,
                          ),
                        ...
                        ListTile(
                          leading: const Icon(Icons.generating_tokens_outlined, color: AppTheme.burntOrange),
                        ...
                        FutureBuilder<int>(
                          ...
                          builder: (context, snapshot) {
                            return ListTile(
                              leading: const Icon(Icons.auto_awesome_rounded, color: AppTheme.burntOrange),
              ...
              GlassContainer(
                child: Column(
                  children: [
                    ListTile(
                      leading: const Icon(Icons.restore_rounded, color: AppTheme.burntOrange),
                      title: const Text("Restore Purchases"),
                      onTap: () => restorePurchases(),
                    ),
                    const Divider(height: 1),
                    ListTile(
                      leading: const Icon(Icons.privacy_tip_outlined, color: AppTheme.burntOrange),
                      title: const Text("Privacy Policy"),
                      onTap: () => _launchURL(kPrivacyPolicyUrl),
                    ),
                    const Divider(height: 1),
                    ListTile(
                      leading: const Icon(Icons.description_outlined, color: AppTheme.burntOrange),
                          ...
                          if (_isDevMode) ...[
                            ...
                            ListTile(
                              leading: const Icon(Icons.add_circle_outline_rounded,
                                  color: Colors.purple),
                              title: const Text("Add 50 Test Tokens"),
                              subtitle: const Text("Simulate purchase success"),
                              onTap: () async {
                                await debugAddTokens(50);
                                if (mounted) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(
                                        content:
                                            Text("Added 50 tokens for testing")),
                                  );
                                }
                              },
                            ),
              ...
              GlassContainer(
                ...
                child: ListTile(
                  ...
                  title: const Text("Reset All Kitchen Data", style: TextStyle(color: Colors.redAccent)),
                  onTap: () async {
                    ...
                    final confirm = await showDialog<bool>(
                      ...
                      builder: (context) => AlertDialog(
                        ...
                        content: const Text("This will delete all your saved kitchens and reset tokens. This action cannot be undone.", style: TextStyle(color: Colors.white70)),
                        actions: [
