...
class _AnalyticsScreenState extends State<AnalyticsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<List<KitchenModel>>(
        ...
        builder: (context, snapshot) {
          ...
          final allKitchens = [...kitchens, ...MockData.initialHistory];
          
          // Analytics Logic
          int total = allKitchens.length;
          
          // Style Distribution
          final styleCounts = <String, int>{};
          for (var g in allKitchens) {
            ...
            child: Column(
              children: [
                ...
                Row(
                  children: [
                    Expanded(
                      child: _StatCard(label: "Total Created", value: "$total", icon: Icons.kitchen_rounded),
                    ),
...
class _StatCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GlassContainer(
      ...
      child: Column(
        children: [
          Icon(icon, size: 30, color: AppTheme.burntOrange),
