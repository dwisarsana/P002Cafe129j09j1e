// RevenueCat + helper premium for Kitchen AI (iOS + Android ready)
...
const appId =
    'app.kitchen.ai'; // Kitchen AI identifier

const entitlementKey = 'kitchen'; // Generic entitlement key
const int kPremiumDailyLimit = 10;

const tokenPack5Id = 'ai.kitchen.token5';
...
const String _kTotalGenerationKey = 'kitchen_ai_total_generations';
...
const String _kDevModeKey = 'kitchen_developer_mode_enabled';
...
const _kPremiumDailyKeyPrefix = 'kitchen_ai_premium_daily_';
...
Future<bool> presentPaywallGuarded(
  ...
  try {
    debugPrint('🟢 Opening Kitchen AI paywall (forceLoading: $forceLoading)...');
    await Navigator.of(context).push(
      MaterialPageRoute(
        fullscreenDialog: true,
        builder: (_) => KitchenAIPaywall(forceLoading: forceLoading),
      ),
    );
