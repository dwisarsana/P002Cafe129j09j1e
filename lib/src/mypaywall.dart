...
// Kitchen AI — Premium Paywall Screen
...
class KitchenAIPaywall extends StatefulWidget {
  final bool forceLoading;
  const KitchenAIPaywall({super.key, this.forceLoading = false});

  @override
  State<KitchenAIPaywall> createState() => _KitchenAIPaywallState();
}

class _KitchenAIPaywallState extends State<KitchenAIPaywall>
    ...
    try {
      ...
      if (isPro) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Welcome to Kitchen AI Premium!')),
        );
      }
    } catch (e) {
      if (mounted) {
            ...
            child: Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    AppTheme.burntOrange.withValues(alpha: 0.18),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 8),
          const Text(
            'Transform your kitchen with unlimited AI power and exclusive designs.',
          ...
          _feature(CupertinoIcons.infinite, 'Unlimited Kitchen generations'),
          _feature(
            CupertinoIcons.paintbrush,
            'Access all 100+ Premium kitchen styles',
          ),
          _feature(CupertinoIcons.photo_fill, 'High-resolution 4K exports'),
          _feature(CupertinoIcons.bolt_fill, 'Priority AI Rendering'),
          _feature(CupertinoIcons.star_fill, 'Exclusive early-access designs'),
  ...
  Widget _feature(IconData icon, String text) {
    return Padding(
      ...
      child: Row(
        children: [
          Icon(icon, color: AppTheme.burntOrange, size: 18),
